...
feature_pool = ["beta", 
                  "vol_5d", "vol_20d", "vol_120d", 
                  "SPY_vol_5d", "SPY_vol_20d", "SPY_vol_120d", 
                  "vol_ratio_5d_120d"]
...
Conclusion:
(1) Feature to remove:
    - vol_5d (high colinearity)
    - SPY_vol_5d (low t-statistics, low colinearity)
    - vol_ratio_5d_120d (low t-statistics, low colinearity)
...
(2) Feature to add (non-linearity):
    ...
    - beta**2
'''
feature_dict["SPY_vol_20d*beta"] = np.multiply(feature_dict["SPY_vol_20d"], feature_dict["beta"])
feature_dict["vol_20d*beta"] = np.multiply(feature_dict["vol_20d"], feature_dict["beta"])
...
feature_column = ["beta", 
                  "vol_20d", "vol_120d", 
                  "SPY_vol_20d", "SPY_vol_120d", 
                  "SPY_vol_20d*beta", "vol_20d*beta", "beta**2"
                  ]
...
file_name = os.path.join(os.getcwd(), "feature_vote_volatility.pkl")
with open(file_name, "wb") as f:
